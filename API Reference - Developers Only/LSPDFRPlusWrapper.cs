...
public static class LSPDFRPlusFunctions
{
    ...
    {
        CreateNewCourtCase(DefendantPersona, Crime, GuiltyChance, CourtVerdict, ResultsPublishTime);
    }
    ...
    {
        return DeterminePrisonSentence(MinMonths, MaxMonths, SuspendedChance);
    }
    ...
    {
        return DetermineFineSentence(MinFine, MaxFine);
    }
    ...
    {
        AddQuestionToTrafficStop(Suspect, Question, Answer);
    }
    ...
    {
        AddQuestionToTrafficStop(Suspect, Question, Answers);
    }
    /// <summary>
    /// Adds a custom question to the traffic stop questioning section.
    /// </summary>
    ...
    {
        AddQuestionToTrafficStop(Suspect, Questions, Answers);
    }
    ...
    {
        AddQuestionToTrafficStop(Suspect, Question, CallbackAnswer);
    }
    ...
    {
        AddQuestionToTrafficStop(Suspect, Question, Answers, Callback);
    }
    ...
    {
        HideStandardTrafficStopQuestions(Suspect, Hide);
    }
    ...
    {
        ResetTrafficStopQuestions(Suspect);
    }
    ...
    {
        return GetCurrentPursuitTactics();
    }
    ...
    {
        return ArePursuitTacticsAutomatic();
    }
}
