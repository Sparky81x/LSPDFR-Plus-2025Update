...
namespace LSPDFR_
{
    internal static class Menus
    {
        ...
        public static bool IsCourtSummonsSelected()
        {
            if (IssueTicketItem != null && IssueTicketItem.Collection.Count > 0)
            {
                return IssueTicketItem.Collection[IssueTicketItem.Index].ToString().Contains("Court");
            }
            return false;
        }
    }
